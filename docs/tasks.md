...
Current work queue. Updated by /sync.
...
## Completed
- [x] Build all 7 nav pages (index, music, about, shows, contact, faq, blog)
- [x] Add YouTube Shorts grid and live band embed to music.html
- [x] Add real Pherkad tour dates to shows.html
- [x] Fix YouTube channel link on music page
- [x] Reorder nav tabs, fix post.html active state
- [x] Mobile layout improvements (gutters, section padding, footer social wrap, shorts centering)
